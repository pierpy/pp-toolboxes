function [b_model, b_ind, b_loading, exp_var] = itab_modifiedkmeans(eeg, n_mod, reruns)
    % output arguments
    ...
    % input arguments
        ...
        %  .confstruct.pmode = polarity mode: 0 polarity indipendent; 1 polarity dependent

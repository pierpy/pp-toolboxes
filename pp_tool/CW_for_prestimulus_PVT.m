function [ NMicr ] = CW_for_prestimulus_PVT( eeg, confstruct )
...
for q = 1 : numclusters
    ...
    switch confstruct.algorithm
        case 1 % Nmicrostates alg.
             ...
             [mps, ind, assigned_cluster_ampl, exp_var] = NMicrostates(data, ClusterNr(q), confstruct.pmode  , 1);

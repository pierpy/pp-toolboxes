...
pathControls='C:\Users\Pierpaolo\Documents\MATLAB\Microstati\Dati\Results\GroupFitControlsF2\csvFiles';
pathLeft='C:\Users\Pierpaolo\Documents\MATLAB\Microstati\Dati\Results\GroupFitLeftF2\csvFiles';
pathRight='C:\Users\Pierpaolo\Documents\MATLAB\Microstati\Dati\Results\GroupFitRightF2\csvFiles';
...
groupControlsF2(:,k)=[meanGevA;meanGevB;meanGevC;meanGevD;
           meanOccA;meanOccB;meanOccC;meanOccD;
           meanTimeCovA;meanTimeCovB;meanTimeCovC;meanTimeCovD;
           meanNumTFA;meanNnumTFB;meanNnumTFC;meanNnumTFD;
           meanDurA;meanDurB;meanDurC;meanDurD;
...
groupLeftF2(:,k)=[meanGevA;meanGevB;meanGevC;meanGevD;
           meanOccA;meanOccB;meanOccC;meanOccD;
           meanTimeCovA;meanTimeCovB;meanTimeCovC;meanTimeCovD;
           meanNumTFA;meanNnumTFB;meanNnumTFC;meanNnumTFD;
           meanDurA;meanDurB;meanDurC;meanDurD;
...
groupRightF2(:,k)=[meanGevA;meanGevB;meanGevC;meanGevD;
           meanOccA;meanOccB;meanOccC;meanOccD;
           meanTimeCovA;meanTimeCovB;meanTimeCovC;meanTimeCovD;
           meanNumTFA;meanNnumTFB;meanNnumTFC;meanNnumTFD;
           meanDurA;meanDurB;meanDurC;meanDurD;
...
% for k=1:size(groupControlsF2,1)
%     [h_Controls_vs_Left(k),p_Control_vs_Left(k)]=ttest2(groupControlsF2(k,:),groupLeftF2(k,:));
% end
% for k=1:size(groupControlsF2,1)
%     [h_Controls_vs_Right(k),p_Control_vs_Right(k)]=ttest2(groupControlsF2(k,:),groupRightF2(k,:));
% end
% for k=1:size(groupControlsF2,1)
%     [h_Left_vs_Right(k),p_Left_vs_Right(k)]=ttest2(groupLeftF2(k,:),groupRightF2(k,:));
% end

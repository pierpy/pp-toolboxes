...
%
% $Id: ft_read_mri.m 7274 2013-01-03 08:14:28Z jansch $
...
elseif strcmp(mriformat, 'dicom_old')  
  ...
  % reorder the slices
  if ~isfield(hdr,'SliceLocation') & isfield(hdr,'ImagePositionPatient')
      for i = 1:length(hdr)
          hdr(i).SliceLocation = hdr(i).ImagePositionPatient(3);
      end
  end

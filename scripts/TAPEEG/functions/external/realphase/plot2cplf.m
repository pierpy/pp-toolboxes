function plot2cplf(f1,f2,pltype,fignum,xl,yl,zl1,zl2,tit)

% This function plots two coupling functions in one graphic
% window.
%
%  Forms of call 
%       plot2cplf(f1,f2,pltype,fignum,xl,yl,zl1,zl2,tit)
%       plot2cplf(f1,f2,pltype,fignum)
%       plot2cplf(f1,f2,pltype)
%
%  Input:  f1,f2   are the functions of (proto)phases 

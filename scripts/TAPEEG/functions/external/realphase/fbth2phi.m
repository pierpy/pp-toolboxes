function [phi1, phi2] = fbth2phi(theta1, theta2, sigfc1, sigfc2)

% This function performs the theta --> phi transformation,
% using the coefficients sigfc1, sigfc2, provided by fbsolv.
%
% Form of call: [phi1,phi2] = fbth2phi(theta1,theta2,sigfc1,sigfc2)
% Input:  
%        theta1: Protophase of the 1st oscillator
%        theta2: Protophase of the 2nd oscillator
%        sigfc1: Coefficients of phase transformation, provided by fbsolv
%        sigfc2: Coefficients of phase transformation, provided by fbsolv
%   
% Output:

function plot2coef(F1,F2,pltype,fignum,own_lab_1,ext_lab_1,tit_1,own_lab_2,ext_lab_2,tit_2)
%
% The purpose of this function is to plot the results.
%
%       Forms of call 
%       plot2coef(F1,F2,pltype,fignum,own_lab_1,ext_lab_1,tit_1,own_lab_2,ext_lab_2,tit_2)
%       plot2coef(F1,F2,pltype,fignum)
%       plot2coef(F1,F2,pltype)
%
%
...
%
%       If plot2coef is called with pltype = 1 or pltype = 2, then 
...
%   
%       If plot2coef is called with pltype=0, then the axes are

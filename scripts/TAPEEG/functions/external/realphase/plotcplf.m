function plotcplf(f,pltype,fignum,own_lab,ext_lab,zlab,tit)

% This function plots coupling function
%
%  Forms of call 
%       plotcplf(f,pltype,fignum,own_lab,ext_lab,zlab,tit)
%       plotcplf(f,pltype,fignum)
%       plotcplf(f,pltype)
%
...
%                  have no effect;
%                  pltype >1 means that f is a function of protophases, the
...
%                  pltype > 0), then a new graphic window will be opened.
%

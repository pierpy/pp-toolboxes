function [COR, Delta_self, Delta_ext, q2_shift]=gcfcor(q1,q2)
...
% Form of call: 
%               [COR] = gcfcor(q1, q2)
%               [COR, Delta_self] = gcfcor(q1, q2) 
%               [COR, Delta_self, Delta_ext]=gcfcor(q1, q2) 
%               [COR, Delta_self, Deltaext, q2_shift]=fbcfcor(q1, q2) 
% Input:
...
q2_shift(:,end+1)=q2_shift(:,1); % Adding last points assume  periodicity.

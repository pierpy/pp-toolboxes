...
switch tmp
    case 'PCWIN64'
        path_ = fullfile(fullfile(Main_Path,'Xpdf'),['bin64' filesep 'pdftops.exe']);
    case 'PCWIN32'
        path_ = fullfile(fullfile(Main_Path,'Xpdf'),['bin32' filesep 'pdftops.exe']);
    case 'GLNX86'
        path_ = fullfile(fullfile(Main_Path,'Xpdf'),['bin32' filesep 'pdftops']);
    case 'GLNXA6'
        path_ = fullfile(fullfile(Main_Path,'Xpdf'),['bin64' filesep 'pdftops']);
    otherwise
        path_ = '';
end
clearvars tmp

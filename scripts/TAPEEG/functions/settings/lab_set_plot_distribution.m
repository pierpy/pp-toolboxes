function settings = lab_set_plot_distribution(settings,data,measures)
...
[settings,Cancelled] = inputsdlg(Prompt,'Plot distribution',Formats,settings);
if Cancelled == 1
    settings = [];
end

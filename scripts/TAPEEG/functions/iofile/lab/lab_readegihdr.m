% lab_readegihdr() - read header information from EGI (versions 2,3,4,5,6,7) data file.
%
% Usage:
%   >> [head] = lsb_readegihdr(fid,forceversion)
%
% Input:
...
function head = lab_readegihdr(fid,forceversion)
